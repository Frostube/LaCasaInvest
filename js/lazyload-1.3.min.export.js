function t_lazyload_update() {
    "undefined" != typeof lazyload_cover && lazyload_cover.update(), "undefined" != typeof lazyload_img && lazyload_img
      .update(), "undefined" != typeof lazyload_bgimg && lazyload_bgimg.update(), "undefined" != typeof lazyload_iframe &&
      lazyload_iframe.update()
  }
  ...
  function t_lazyload_updateResize_elem(e) {
    ...
    if (null != e) {
      var t = e.tagName;
      if ("IMG" == t) var o = e.getAttribute("src"),
        n = "-/resize/";
      ...
      if (!(null == o || -1 === o.indexOf(n) || o.indexOf(".svg") > 0 || o.indexOf(".gif") > 0 || o.indexOf(".ico") > 0 ||
          -1 === o.indexOf("thumb.tildacdn.com") || o.indexOf("-/empty/") > 0 && o.indexOf("-/resizeb/") > 0)) {
        ...
        if (l > 0 && a > 0) {
          var r = o.slice(l, a).split("x"),
            s = e.clientWidth,
            c = e.clientHeight;
          if (s > 0 && c > 0 && (r[0] > 0 || r[1] > 0) && (r[0] > 0 && s > r[0] || r[1] > 0 && c > r[1]) && (r[0] > 0 &&
              s - r[0] > 100 || r[1] > 0 && c - r[1] > 100)) {
    ...
    function n(e, t, o) {
      ...
      return n = e.ownerDocument, i = window.pageYOffset || n.body.scrollTop, l = window.pageXOffset || n.body
        .scrollLeft, "fixed" === e.getAttribute("data-content-cover-parallax") && e.closest && e.closest(
          ".t-cover__container") && (e = e.closest(".t-cover__container")), !(d() || _() || u() || h())
    }
    ...
    function a(e) {
      ...
      return t.forEach((function(e) {
        e.isSkipByPosition = null === e.offsetParent && 0 === r(e, ".t396__carrier-wrapper").length &&
          "fixed" !== e.getAttribute("data-content-cover-parallax"), e.isNotUnderScreenRange = 0 === r(e,
            ".t-rec[data-screen-max]").length && 0 === r(e, ".t-rec[data-screen-min]").length
      })), t
    }
  
    function r(e, t) {
      for (var o = [];
        (e = e.parentNode) && e !== document;) t && !e.matches(t) || o.unshift(e);
      return o
    }
    ...
    function c(e, t) {
      g ? e.classList.remove(t) : e.className = e.className.replace(new RegExp("(^|\\s+)" + t + "(\\s+|$)"), " ")
        .replace(/^\s+/, "").replace(/\s+$/, "")
    }
    ...
    function d(e, t, o, n) {
      var i = t.getAttribute("data-" + n),
        ...
        a = e.tagName;
      return "IMG" === a ? (l && e.setAttribute("srcset", l), void(i && e.setAttribute("src", i))) : "IFRAME" === a ?
        void(i && e.setAttribute("src", i)) : void(e.style.backgroundImage = "url(" + i + ")")
    }
    ...
    function _(o) {
      e(), this._settings = l(h, o), this._queryOriginNode = this._settings.container === window ? document : this
        ._settings.container, this._previousLoopTime = 0, this._loopTimeout = null, this._handleScrollFn = u(this
          .handleScroll, this), t(window, "resize", this._handleScrollFn), this.update()
    }
    window.t_lazyload_setSources = d;
    var h, p, f, g, m = !1;
    return _.prototype._showOnLoad = function(e) {
      function n() {
        null !== l && (l.callback_load && l.callback_load(e), d(e, e, l.data_srcset, l.data_src), l.callback_set &&
          l.callback_set(e), c(e, l.class_loading), s(e, l.class_loaded), o(i, "load", n))
      }
      var i, l = this._settings;
      e.getAttribute("src") || e.setAttribute("src", l.placeholder), t(i = document.createElement("img"), "load",
        n), t(i, "error", (function() {
      ...
      function n() {
        null !== i && (i.callback_load && i.callback_load(e), c(e, i.class_loading), s(e, i.class_loaded), o(e,
          "load", n))
      }
      ...
      var e, t, o = this._settings,
        i = this._elements,
        l = i ? i.length : 0,
        a = [];
      for (e = 0; l > e; e++) t = i[e], o.skip_invisible && t.isSkipByPosition || n(t, o.container, o.threshold) &&
        (o.show_while_loading ? this._showOnAppear(t) : this._showOnLoad(t), a.push(e), t.wasProcessed = !0);
      ...
      var e, t, o = this._elements,
        n = o.length,
        i = [];
      for (e = 0; n > e; e++)(t = o[e]).wasProcessed && i.push(e);
      for (; i.length > 0;) o.splice(i.pop(), 1)
    }, _.prototype._startScrollHandler = function() {
      this._isHandlingScroll || (this._isHandlingScroll = !0, t(this._settings.container, "scroll", this
        ._handleScrollFn))
    }, _.prototype._stopScrollHandler = function() {
      this._isHandlingScroll && (this._isHandlingScroll = !1, o(this._settings.container, "scroll", this
        ._handleScrollFn))
    }, _.prototype.handleScroll = function() {
      var e, t, o;
      this._settings && (t = i(), 0 !== (o = this._settings.throttle) ? 0 >= (e = o - (t - this
        ._previousLoopTime)) || e > o ? (this._loopTimeout && (clearTimeout(this._loopTimeout), this
          ._loopTimeout = null), this._previousLoopTime = t, this._loopThroughElements()) : this._loopTimeout || (
          this._loopTimeout = setTimeout(u((function() {
      ...
      this._elements = a(this._queryOriginNode.querySelectorAll(this._settings.elements_selector)), this
        ._purgeElements(), this._loopThroughElements(), this._startScrollHandler()
    }, _.prototype.destroy = function() {
      o(window, "resize", this._handleScrollFn), this._loopTimeout && (clearTimeout(this._loopTimeout), this
          ._loopTimeout = null), this._stopScrollHandler(), this._elements = null, this._queryOriginNode = null,
        this._settings = null
    }, _
