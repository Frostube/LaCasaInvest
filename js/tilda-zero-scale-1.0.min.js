function t396_scaleBlock(e) {
    ...
    if (a) {
      var l;
      "function" == typeof window.t396__getCurrentScaleFactor ? l = t396__getCurrentScaleFactor(e) : (l = window.tn &&
        window.tn["ab" + e] && window.tn["ab" + e].scaleFactor) || (l = window.tn_scale_factor);
      ...
      if (n && 0 !== o.length) {
        ...
        if (t396_scale__updateArtboardState(n, c), t396_isOnlyScalableBrowser()) t396_scale__scaleIsOnlyScalableBlock(o);
        else {
          ...
          p && t396_scale__schedule__scaleTextElements(m), t396_scale__schedule__scaleShapeElements(h), o.forEach((
            function(e) {
              var a = e.element,
                n = e.elementCore,
                o = e.elemType,
                r = "gallery" === o;
              "yes" === a.getAttribute("data-scale-off") || r || (a.style.zoom = l), r && (a.style.zoom = null),
                "text" === o && t < 1200 && n && !p && (n.style.webkitTextSizeAdjust = "auto"), n && (n.style
  ...
  function t396_scale__schedule__scaleTextElements(e) {
    window.tn || (window.tn = {}), window.tn.scheduledTextElementsForScale || (window.tn
      .scheduledTextElementsForScale = []), window.tn.scheduledTextElementsForScale = window.tn
      .scheduledTextElementsForScale.concat(e), clearTimeout(window.tn.textElementsScaleTimer), window.tn
      .textElementsScaleTimer = setTimeout((function() {
        t396_scale__scaleTextElements(window.tn.scheduledTextElementsForScale), window.tn
          .scheduledTextElementsForScale = []
      }), 1)
  }
  ...
  function t396_scale__scaleTextElements(e) {
    ...
    t.write((function() {
      ...
      e.forEach((function(e) {
        e.cachedFontSize = parseFloat(getComputedStyle(e.elementCore).fontSize), e.cachedTextSizeAdjust = e
          .elementCore.style.webkitTextSizeAdjust
      }))
    })), t.write((function() {
      e.forEach((function(e) {
      ...
      e.forEach((function(e) {
        ...
        e.elementCore.style.webkitTextSizeAdjust = t >= 1 ? "none" : e.cachedTextSizeAdjust, t >= 1 && (e
          .elementCore.style.fontSize = Math.round(e.cachedFontSize * e.scaleFactor) + "px")
      }))
    }))
  }
  
  function t396_scale__schedule__scaleShapeElements(e) {
    window.tn || (window.tn = {}), window.tn.scheduledShapeElementsForScale || (window.tn
        .scheduledShapeElementsForScale = []), window.tn.scheduledShapeElementsForScale = window.tn
      .scheduledShapeElementsForScale.concat(e), clearTimeout(window.tn.shapeElementsScaleTimer), window.tn
      .shapeElementsScaleTimer = setTimeout((function() {
        t396_scale__scaleShapeElements(window.tn.scheduledShapeElementsForScale), window.tn
          .scheduledShapeElementsForScale = []
      }), 1)
  }
  ...
  function t396_scale__scaleShapeElements(e) {
    ...
    t.read((function() {
      e.forEach((function(e) {
        ...
        t = t396_elem__getHeight(e.element, t), t = t396_elem__convertPosition__Local__toAbsolute(e.element,
          "height", t);
        var a = t396_elem__getFieldValue(e.element, "width");
        a = t396_elem__getWidth(e.element, a), a = t396_elem__convertPosition__Local__toAbsolute(e.element,
          "width", a);
        ...
        n = t396_elem__convertPosition__Local__toAbsolute(e.element, "left", n), e.shapeSize = {
          top: l,
          left: n,
          width: a,
          height: t
    ...
    t.read((function() {
      a.forEach((function(e) {
        ...
        e.borderWidth = t.borderWidth, e.isImage = "none" !== t.backgroundImage, e.isAnimated = e.element
          .getAttribute("data-animate-sbs-event")
      }))
    })), t.write((function() {
      a.forEach((function(e) {
        if ("0px" === e.borderWidth && !e.isImage && !e.isAnimated) {
          ...
          e.element.style.width = parseFloat(t) + "px", e.element.style.height = parseFloat(a) + "px", e
            .element.style.top = Math.round(l) + "px", e.element.style.left = Math.round(n) + "px", e.element
            .setAttribute("data-scale-off", "yes")
        }
      }))
    }))
  }
  ...
  function t396_scale__scaleIsOnlyScalableBlock(e) {
    e.forEach((function(e) {
      ...
      n || (t396_scale__wrapElement(a, currentScaleFactor, "tn-atom__scale-wrapper"), n = a.closest(
          ".tn-atom__scale-wrapper")), t.style.zoom = "", t396_scale__processBackdropFilter(t, a, n),
        t396_scale__processBackgroundForShape(t, a, l, currentScaleFactor)
    }))
  }
  
  function t396_scale__getElementsToScale(e) {
    return e ? Array.prototype.slice.call(e.children).filter((function(e) {
  ...
  function t396_scale__updateArtboardState(e, t) {
    ...
    if (!("hug" === e.getAttribute("data-artboard-heightmode"))) {
      var n = '<style class="t396__scale-style">.t-rec#rec' + a + " { overflow: visible; }#rec" + a +
        " .t396__artboard:not(.t396__artboard-flex),#rec" + a +
        " .t396__artboard:not(.t396__artboard-flex) .t396__carrier,#rec" + a +
        " .t396__artboard:not(.t396__artboard-flex) .t396__filter { width: 100vw !important; max-width: 100%;}#rec" + a +
        " .t396__carrier,#rec" + a + " .t396__filter,#rec" + a + " .t396__artboard {height: " + t +
        "px !important;}</style>";
    ...
    if ("shape" === a) {
      ...
      if (n)
        if ((n && n.backgroundImage || t.getAttribute("data-original")) && "fixed" === n.backgroundAttachment) {
          ...
          e.style.top = i * l + "px", e.style.left = _ * l + "px", e.style.height = r * l + "px", e.style.width = c * l +
            "px", e.setAttribute("data-scale-off", "yes")
        }
    }
  }
