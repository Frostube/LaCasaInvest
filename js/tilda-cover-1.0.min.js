function t_cover__parallax(e) {
  ...
  function cover_init(e) {
    ...
    if (n) {
      ...
      (window.t_cover__isMobile || "ontouchend" in document) && v && !o && (n.style.backgroundImage = 'url("' + c[
        "cover-bg"] + '")'), setTimeout((function() {
        t_cover__recalcContentHeight(e, !1, 0), t_cover__fixBgFixedNode(e)
      }), 300), i && (i.onload = function() {
        t_cover__recalcContentHeight(e, !1, 500)
      }), window.t_cover__isMobile || "ontouchend" in document ? window.addEventListener("orientationchange", (
      function() {
        t_cover__recalcContentHeight(e, !0, 200)
      })) : window.addEventListener("resize", (function() {
        t_cover__recalcContentHeight(e, !1, 0)
      })), t_cover__setListenerToArrow(e), t_cover__setCoverParams(n, c, v), n.addEventListener("displayChanged", (
        function() {
          t_cover__recalcContentHeight(e, !1, 0)
        }))
    }
  ...
  function t_cover__setCoverParams(e, t, o) {
    ...
    if (t_cover__setCoverVideoParams(e, t, o, r), r && window.isOpera && (e.style.transform = "unset"), n && !window
      .t_cover__isMobile) {
    ...
    if (i && t["cover-bg"] && !o) {
      ...
      v.src = t["cover-bg"], v.onload = function() {
        v.parentElement && v.parentElement.removeChild(v), e.style.backgroundImage = 'url("' + t["cover-bg"] + '")', e
          .style.opacity = "1", u = !0
  ...
  function t_cover__setCoverVideoParams(e, t, o, r) {
    var n = "";
    if (t["video-url-youtube"] && (n = "youtube"), (t["video-url-vimeo"] || t["video-url-rutube"] || t[
        "video-url-kinescope"] || t["video-url-vkvideo"]) && (n = "iframe"), (!window.t_cover__isMobile && !(
        "ontouchend" in document) || -1 === ["on", null].indexOf(t["use-image-for-mobile-cover"])) && o) switch (
  ...
  function t_cover__processYouTubeVideo(e, t) {
    ...
    })).observe(e) : (t_cover__createYoutubeCover(e, t["cover-height"]), window.addEventListener("scroll", t_throttle((
      function() {
  ...
  function t_cover__processHTML5Video(e, t, o) {
    ...
    })).observe(e) : (t_cover__createHTMLVideoCover(e, t, a, o, d, _), window.addEventListener("scroll", t_throttle((
      function() {
    ...
    window.addEventListener("scroll", (function() {
      if (o && a) {
        var t = e.parentElement,
          ...
          _;
        i >= d + c ? (e.style.position = "absolute", e.style.bottom = "0px", e.style.top = "auto") : r >= d ? (e
          .style.position = "fixed", e.style.top = "0px") : r < d && (e.style.position = "relative", e.style.top =
          "auto")
      }
    }))
  }
  ...
  function t_cover__setStylesForCoverVideo(e, t) {
    e.style.backgroundColor = "#000000", e.style.backgroundImage = "youtube" === t ? "" :
      'url("https://tilda.ws/img/spinner-white.gif")', e.style.backgroundSize = "youtube" === t ? "" : "unset", e.style
      .backgroundPosition = "youtube" === t ? "" : "center", e.style.backgroundRepeat = "youtube" === t ? "" :
      "no-repeat", e.setAttribute("data-content-cover-bg", "")
  }
  ...
  function t_cover__setListenerToArrow(e) {
    ...
    if (t) {
      ...
      o && o.addEventListener("click", (function() {
        var e, o;
        t.offsetHeight && t_cover__scrollToNextSection(t.offsetHeight + t.getBoundingClientRect().top + window
          .pageYOffset)
      }))
    }
  }
  ...
  function t_cover__initCovers() {
    var e = document.querySelector(".t-records"),
      t, o;
    e && "edit" === e.getAttribute("data-tilda-mode") || Array.from(document.querySelectorAll(".t-cover__carrier"))
      .forEach((function(e) {
  ...
  function t_cover__recalcCoverHeight(e, t) {
    ...
    if (o) {
      ...
      if (r && "935" !== n) {
        ...
        (h > m || h > g) && g < h + p || d || (window.t_cover__isMobile || "ontouchend" in document) && t ? (
            t_cover__setRecalculatedHeight(o, h), t_cover__updateResizeElem(o)) : window.t_cover__isMobile && y ? _
          .forEach((function(e) {
  ...
  function t_cover__getHeightFromAttr(e) {
    return e ? -1 !== e.indexOf("vh") ? parseInt(e, 10) * document.documentElement.clientHeight / 100 : parseInt(e, 10) :
      0
  }
  ...
  function t_cover__setRecalculatedHeight(e, t) {
    ...
    (d || _) && (u = 0, v = 0), (t += u) > 1e3 && (t += v);
    var l = t > i ? t : i,
      s = 0,
      g = [".t-cover", ".t-cover__filter", ".t-cover__carrier", ".t-cover__wrapper"];
    (d || e.querySelector(".t734")) && g.push(".t-slds__items-wrapper"), g.forEach((function(t) {
      var o;
      Array.prototype.slice.call(e.querySelectorAll(t)).forEach((function(e) {
        c && e && e.classList.contains("t-cover__carrier") && l < document.documentElement.clientHeight ? (s =
          .2 * document.documentElement.clientHeight, e.style.height = l + s + "px") : e && (e.style
          .height = l + "px")
      }))
    })), o.setAttribute("data-content-cover-updated-height", l + s + "px");
    var f = document.createEvent("Event");
    f.initEvent("coverHeightUpdated", !0, !0), o.dispatchEvent(f)
  }
  
  function t_cover__getRecordType(e) {
    var t;
    return e && (e.getAttribute("data-record-type") || (null == (t = e.closest(".record")) ? void 0 : t.getAttribute(
      "data-record-type"))) || ""
  }
  ...
  function t_cover__fixBgFixedNode(e) {
    ...
    if (t && o) {
      ...
      if (!document.getElementById("fixed-bg-cover")) {
        ...
        c.id = "fixed-bg-cover";
        var a = "";
        a += ".t-cover__container {", a += "position: relative;", a += "}", a += ".t-cover__container .t-cover {", a +=
          "clip: rect(0, auto, auto, 0);", a += "position: absolute;", a += "top: 0;", a += "left: 0;", a +=
          "width: 100%;", a += "height: 100% !important;", a += "}", a +=
          ".t-cover__container .t-cover .t-cover__carrier {", a += "position: fixed;", a += "display: block;", a +=
          "top: 0;", a += "left: 0;", a += "width: 100%;", a += "height: 100% !important;", a +=
          "background-size: cover;", a += "background-position: center center;", a += "transform: translateZ(0);", a +=
          "will-change: transform;", a += "}", c.textContent = a, document.head.insertAdjacentElement("beforeend", c)
      }
      var d = document.createElement("div");
      d.classList.add("t-cover__container"), i.insertAdjacentElement("afterbegin", d), d.style.height =
        t_cover__getPureHeight(n) + "px", d.appendChild(n);
      var _, u = {
  ...
  function t_cover__scrollToNextSection(e) {
    var t, o = Math.max(document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight,
    ...
    var r = window.pageYOffset,
      ...
      c = setInterval((function() {
        i += n, window.scrollTo(0, i), document.body.setAttribute("data-scrollable", "true"), (e - r < 0 && window
          .pageYOffset <= e || e - r > 0 && window.pageYOffset >= e) && (clearInterval(c), document.body
          .removeAttribute("data-scrollable"))
      }), 10)
  }
  ...
  window.t_cover__isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
    t_onReady((function() {
      t_onFuncLoad("t_cover__initCovers", (function() {
        t_cover__initCovers(), "complete" === document.readyState ? t_cover__setWordWrapOnInit() : window
          .addEventListener("load", t_cover__setWordWrapOnInit)
      }))
    }));
