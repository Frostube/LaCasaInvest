function t_sldsInit(t, e) {
        ...
        if (!i.getAttribute("data-slider-initialized")) {
          ...
          if (l) {
            ...
            var d = l.length,
              ...
              f;
            if (Array.prototype.forEach.call(l, (function(t, e) {
                t.setAttribute("data-slide-index", e + 1), window.t_slds__isiOS && (t.style.transform =
                  "translateZ(0)")
              })), "true" !== i.getAttribute("data-slider-stop")) {
              p || 0 === p || (p = 300), isNaN(p) && i.setAttribute("data-slider-transition", "300"), i.classList
                .contains("t-slds_animated-fast") || i.classList.contains("t-slds_animated-slow") || i.classList.contains(
                  "t-slds_animated-none") || i.classList.add("t-slds_animated-fast");
              var m = u;
              t_slds_setItemsInRow(t), t_slds_changeImageUrl(t);
              var y = 8 === document.documentMode || 9 === document.documentMode;
              y && (i.classList.remove("t-slds_animated-fast"), i.classList.remove("t-slds_animated-slow"), i.classList
                .add("t-slds_animated-none"), i.classList.add("t-slds_ie"), i.setAttribute("data-slider-correct-height",
                  "true"), i.setAttribute("data-slider-items-in-row", 1)), i.setAttribute("data-slider-initialized",
                "true"), i.getAttribute("data-slider-totalslides") || i.setAttribute("data-slider-totalslides", d);
              var v = 1,
                g = i.getAttribute("data-slider-pos");
              g ? v = parseInt(g, 10) : i.setAttribute("data-slider-pos", 1), i.setAttribute("data-slider-cycle", ""), i
                .setAttribute("data-slider-animated", ""), a || t_slds__createDummies(o, n, i), u = parseInt(i
                  .getAttribute("data-slider-items-in-row"), 10) || 0;
              var b = s.querySelectorAll(".t-slds__arrow_wrapper-right");
              b.length && Array.prototype.forEach.call(b, (function(t) {
                  t.style.display = "false" === _ && d - u <= 0 ? "none" : ""
                })), a || t_slds_SliderWidth(t), "true" == i.getAttribute("data-slider-correct-height") &&
                t_slds_SliderHeight(t), t_slds_SliderArrowsHeight(t), t_slds_ActiveSlide(t, v, d), t_slds_ActiveCaption(t,
                  v, d), a ? c > 960 && ("true" === i.getAttribute("data-feeds-posts-loaded") ? (t_slds__initFeedsSlider(
                ...
                }))) : (y || t_slds_onHammerLoad("Hammer", (function() {
                  t_slds_initSliderSwipe(t, d, c)
                })), t_slds_initSliderControls(t, e), t_slds_updateSlider(t)), i.getAttribute("data-slider-timeout") > 0 ?
                t_slds_initAutoPlay(t, v, d, e) : i.addEventListener("slideAutoplayTimerReady", (function() {
                  i.getAttribute("data-slider-timeout") > 0 && t_slds_initAutoPlay(t, v, d, e)
                })), s.querySelectorAll(".t-slds__item-loaded").length < d + 2 && t_slds_UpdateImages(t, v), "yes" == i
                .getAttribute("data-slider-arrows-nearpic") && t_slds_positionArrows(t);
              var h = s.querySelectorAll(".t-slds");
              h.length && Array.prototype.forEach.call(h, (function(t) {
                  t.style.visibility = ""
                })), t_slds__setTabindexForFocusableElements(t), s.removeEventListener("displayChanged",
                  t_slds_updateOnDisplayChange), s.addEventListener("displayChanged", t_slds_updateOnDisplayChange(t, m)),
                a && (s.removeEventListener("displayChanged", t_slds_updateFeedsSliderOnResize), s.addEventListener(
                  "displayChanged", (function() {
                    t_slds_updateFeedsSliderOnResize(t, s, e)
                  }))), window.addEventListener("resize", t_throttle((function() {
                  setTimeout((function() {
                    t_slds_setItemsInRow(t, m), t_slds_updateSlider(t), t_slds_positionArrows(t), a &&
                      t_slds_updateFeedsSliderOnResize(t, s, e)
                  }), 100)
                }))), window.t_slds__isiOS && ("complete" === document.readyState ? t_slds__hideMobileSlides(s
                  .querySelector(".t-slds__item_active")) : window.addEventListener("load", (function() {
              ...
              A && A.addEventListener("allRecPaddingInit", (function() {
                t_slds_updateSlider(t)
              })), document.removeEventListener("click", t_slds__removeAutoplayByVideo), document.addEventListener(
                "click", t_slds__removeAutoplayByVideo)
            }
          }
        }
    }
  ...
  function t_slds__removeAutoplayByVideo(t) {
    var e = t.target.closest(".t-slds__item"),
      s = null == e ? void 0 : e.querySelector("[data-slider-video-type], [data-videolazy-type]");
    if (s) {
      var i = s.closest(".t-slds__items-wrapper"),
        r;
      if (i) i.getAttribute("data-slider-interval-id") && (i.setAttribute("data-slider-stopped", "yes"), i.setAttribute(
        "data-slider-stopped-by-video", "y"))
    }
  }
  ...
  function t_slds__createDummies(t, e, s) {
    var i, r = s.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)").length,
      ...
      n = !1,
      c, u;
    if (t && (c = t.querySelector('[data-zoomable="yes"]')) && (o = !0, c.classList.contains("t-zoomable") && c.classList
        .remove("t-zoomable"), c.removeAttribute("data-zoomable")), e && (u = e.querySelector('[data-zoomable="yes"]')) &&
      (n = !0, u.classList.contains("t-zoomable") && u.classList.remove("t-zoomable"), u.removeAttribute(
      "data-zoomable")), e && 0 == s.querySelectorAll('.t-slds__item[data-slide-index="0"]').length) {
      var _ = e.cloneNode(!0);
      _.setAttribute("data-slide-index", "0"), _.setAttribute("aria-hidden", "true");
      var p = t.parentNode;
      p.insertBefore(_, t);
      var f = p.querySelectorAll('[data-slide-index="0"] [field]');
      f.length && Array.prototype.forEach.call(f, (function(t) {
        t.removeAttribute("field")
      }))
    }
    if (!d && t && !s.querySelector('.t-slds__item[data-slide-index="' + (r + 1) + '"]')) {
      var m = t.cloneNode(!0);
      if (m.setAttribute("data-slide-index", r + 1), m.classList.remove("t-slds__item_active"), m.setAttribute(
          "aria-hidden", "true"), e.insertAdjacentElement("afterend", m), e.classList.add("t-slds__item-loaded"), a > 0 &&
        "true" === l)
        for (var y = t, v = e, g = 0; g < a - 1; g++) {
          var b = y.nextElementSibling.cloneNode(!0);
          b.setAttribute("data-slide-index", r + g + 1), v.nextElementSibling.insertAdjacentElement("afterend", b), v = v
            .nextElementSibling, y = y.nextElementSibling
        }
    }
    o && c && (c.classList.add("t-zoomable"), c.setAttribute("data-zoomable", "yes")), n && u && (u.classList.add(
      "t-zoomable"), u.setAttribute("data-zoomable", "yes"))
  }
  ...
  function t_slds__hideMobileSlides(t) {
    if (t) {
      ...
      if (!s || "scroll" !== s.overflowX || "flex" !== s.display) {
        ...
        if (!(i.length <= 2 * r)) {
          for (var a = t.getAttribute("data-slide-index"), l = [a = parseInt(a, 10)], d = 1; d < r; d++) a + d <= i
            .length ? l.push(a + d) : l.push(d), a - d > 0 ? l.push(a - d) : l.push(i.length + 1 - d);
          var o = "t-slds__item-innactive";
          i.forEach((function(t) {
            var e;
            l.some((function(e) {
              return parseInt(t.getAttribute("data-slide-index"), 10) === e
            })) ? t.classList.remove(o) : t.classList.add(o)
          }))
        }
      }
    }
  ...
  function t_slds_updateFeedsSliderOnResize(t, e, s) {
    var i = e.querySelector(".t-slds__items-wrapper"),
      r;
    i && (i.classList.contains("js-feed-container") && (window.innerWidth > 960 ? "true" === i.getAttribute(
        "data-feeds-posts-loaded") ? (t_slds__initFeedsSlider(t, e, s), t_slds_initSliderControls(t, s)) : document
      .addEventListener("feedsLoadPosts", (function() {
  ...
  function t_slds_setItemsInRow(t, e) {
    ...
    if (s) {
      var i = s.querySelector(".t-slds__items-wrapper"),
        r, a;
      if (i)(i.getAttribute("data-slider-items-in-row") || 0) && (window.innerWidth <= 960 && (a = 2), window
        .innerWidth <= 640 && (a = 1), window.innerWidth > 960 && (a = e)), a && i.setAttribute(
        "data-slider-items-in-row", a)
    }
  }
    ...
    if (s) {
      ...
      if (i) {
        ...
        if ("true" !== i.getAttribute("data-slider-stop")) {
          ...
          n.length && Array.prototype.forEach.call(n, (function(r) {
            r.addEventListener("click", (function() {
              var r = t_slds_getCurrentTranslate(s),
                ...
                n = "",
                c;
              "" == a && (i.setAttribute("data-slider-animated", "yes"), "left" === this.getAttribute(
                  "data-slide-direction") ? "false" == o && 1 == l ? l = 1 : l-- : "false" == o && l == d ?
                l = d : l++, i.setAttribute("data-slider-pos", l), l != d + 1 && 0 != l || (n = "yes"), i
                .setAttribute("data-slider-cycle", n), t_slideMoveWithoutAnimation(t, !1, e, r));
              t_slds_updateSlider(t)
            }))
          }));
          var c = s.querySelectorAll(".t-slds__bullet");
          c.length && Array.prototype.forEach.call(c, (function(r) {
            r.addEventListener("click", (function() {
              ...
              if (parseInt(i.getAttribute("data-slider-pos"), 10) !== a) {
                ...
                i.setAttribute("data-slider-pos", a), t_slideMoveWithoutAnimation(t, !1, e, d),
                  t_slds_updateSlider(t)
              }
            }))
          }))
  ...
  function t_slds_animate(t, e, s) {
    ...
    requestAnimationFrame((function r(a) {
      ...
      l > 1 && (l = 1);
      var d = t(l);
      e(d), l < 1 ? requestAnimationFrame(r) : "y" !== window.lazy && "yes" !== document.querySelector(
        "#allrecords").getAttribute("data-tilda-lazy") || t_slds_onHammerLoad("t_lazyload_update", (function() {
        t_lazyload_update()
      }))
    }))
  }
    ...
    if (i) {
      ...
      if (r) {
        var a = parseFloat(r.getAttribute("data-slider-pos")),
          l, d = (r.getAttribute("data-slider-items-in-row") || 0) > 0 ? i.querySelector(
            ".t-slds__container .t-slds__item").offsetWidth : i.querySelector(".t-slds__container").offsetWidth,
        ...
        if (_ && ("function" == typeof window.CustomEvent ? (c = new CustomEvent("tildaSldsMoveSlideStart"), u =
            new CustomEvent("tildaSldsMoveSlideEnd")) : ((c = document.createEvent("CustomEvent")).initCustomEvent(
            "tildaSldsMoveSlideStart", !0, !0), (u = document.createEvent("CustomEvent")).initCustomEvent(
            "tildaSldsMoveSlideEnd", !0, !0)), i.dispatchEvent(c)), n) {
          ...
          if (p && 0 === i.querySelectorAll(".t-slds__item_dummy").length) {
            ...
            m.classList.add("t-slds__item_dummy"), m.style.position = "absolute", m.style.left = d * a + "px", r
              .appendChild(m), (y = i.classList.contains("js-product") ? i : i.querySelector(".t-store") || i
                .querySelector(".js-product")) ? (t_slds_fadeOut(m, 150, (function() {
      ...
      if (r) {
        ...
        if (a > o + 1 && (a = 1), n) {
          ...
          if (c && 0 === i.querySelectorAll(".t-slds__item_dummy").length) {
            var u = c.cloneNode(!0);
            u.classList.add("t-slds__item_dummy"), u.style.position = "absolute", u.style.left = d * a + "px", r
              .appendChild(u), t_slds_fadeOut(u, 400, (function() {
    ...
    if (i) {
      ...
      if (r) {
        var a = i.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)"),
          ...
          n = d > 0 ? i.querySelector(".t-slds__container .t-slds__item").offsetWidth : i.querySelector(
            ".t-slds__container").offsetWidth,
        ...
        if (/^((?!chrome|android).)*safari/i.test(navigator.userAgent)) {
          var h = navigator.appVersion.match(/Version\/(\d+)\.(\d+)\.?(\d+)? Safari/);
          null !== h && (b = parseInt(h[1], 10))
        }
        var A = !!navigator.userAgent.match("CriOS"),
          S;
        if (c || 0 === c || (c = 300), u > _ + 1 && (u = 1, r.setAttribute("data-slider-pos", 1)), "true" !== r
          .getAttribute("data-slider-stop")) {
          if (y)
            if (l) {
              var w = a[a.length - 1],
              ...
              if (d < _ && t_slds_fadeIn(y, 300), q < _ && d > 0 && (u == q - o + 1 || q === o)) {
                ...
                E.initEvent("feedsLastSlide", !0, !0), r.dispatchEvent(E), document.addEventListener("feedsLoadSlide", (
                  function() {
                    t_slds_updateSlider(t), "function" == typeof t_animate__startAnimation &&
                      t_animate__startAnimation()
                  })), t_slds_fadeIn(y, 300)
              } else q === _ && u === _ - d + 1 && t_slds_fadeOut(y, 300)
            } else "false" == r.getAttribute("data-slider-with-cycle") && (u == _ || d > 1 && u == _ - d + 1) ?
              t_slds_fadeOut(y, 300) : t_slds_fadeIn(y, 300);
          v && ("false" == r.getAttribute("data-slider-with-cycle") && 1 == u ? t_slds_fadeOut(v, 300) : t_slds_fadeIn(v,
              300)), r.classList.add("t-slds_animated"), b >= 13 && A && !f ? t_slide_MoveAnimation(r, u, n, c) : r.style
            .transform = "translateX(-" + n * u + "px)", t_triggerEvent(r, "slideChangeStart"), setTimeout((function() {
              r.classList.remove("t-slds_animated"), r.setAttribute("data-slider-animated", ""), "yes" == (p = r
                .getAttribute("data-slider-cycle")) && (u == _ + 1 && (u = 1), 0 == u && (u = _), b >= 13 && A && !
                f ? t_slide_MoveAnimation(r, u, n, 0) : r.style.transform = "translateX(-" + n * u + "px)", !0 !==
                f && t_slds_ActiveSlide(t, u, _, s), r.setAttribute("data-slider-pos", u)), ("y" === window.lazy ||
                document.querySelector("#allrecords") && "yes" === document.querySelector("#allrecords")
                .getAttribute("data-tilda-lazy")) && t_slds_onHammerLoad("t_lazyload_update", (function() {
                t_lazyload_update()
              })), !e && m && t_slds_initAutoPlay(t, u, _, s)
            }), c), t_slds_ActiveBullet(t, u, _, s), t_slds_ActiveSlide(t, u, _), "true" == r.getAttribute(
              "data-slider-correct-height") && t_slds_SliderHeight(t), t_slds_SliderArrowsHeight(t), t_slds_ActiveCaption(
              t, u, _), i.querySelectorAll(".t-slds__item-loaded").length < _ + 2 && t_slds_UpdateImages(t, u)
        }
      }
    }
  }
  ...
  function t_slds_updateSlider(t) {
    ...
    if (e) {
      ...
      if (s) {
        ...
        d > o + 1 && (d = 1, s.setAttribute("data-slider-pos", 1)), c && (c.style.display = "false" === n && (o - i <=
            0 || d === o) ? "none" : ""), s.style.transform = "translateX(-" + l * d + "px)", "true" == s.getAttribute(
            "data-slider-correct-height") && t_slds_UpdateSliderHeight(t), t_slds_UpdateSliderArrowsHeight(t), "y" === s
          .getAttribute("data-slider-stopped-by-video") && s.setAttribute("data-slider-stopped-by-video", "")
      }
    }
  }
  ...
  function t_slds_UpdateImages(t, e) {
    ...
    if (s) {
      ...
      i && (i.classList.add("t-slds__item-loaded"), i.nextElementSibling && i.nextElementSibling.classList.add(
        "t-slds__item-loaded"), i.previousElementSibling && i.previousElementSibling.classList.add(
        "t-slds__item-loaded"))
    }
  }
  ...
  function t_slds_ActiveCaption(t, e, s) {
    ...
    if (i) {
      ...
      })), 0 == e ? a = i.querySelector('.t-slds__caption[data-slide-caption="' + s + '"]') : e == s + 1 && (a = i
        .querySelector('.t-slds__caption[data-slide-caption="1"]')), a && a.classList.add("t-slds__caption-active")
    }
  }
  ...
  function t_slds_ActiveBullet(t, e, s, i) {
    ...
    if (d) {
      ...
      if (Array.prototype.forEach.call(o, (function(t) {
        ...
        })), i && i.thumbsbulletGallery && e >= r && e != s + 1 || s >= r && 0 == e ? n = d.querySelector(
          '.t-slds__bullet[data-slide-bullet-for="' + r + '"]') : 0 == e ? n = d.querySelector(
          '.t-slds__bullet[data-slide-bullet-for="' + s + '"]') : e == s + 1 && (n = d.querySelector(
          '.t-slds__bullet[data-slide-bullet-for="1"]')), n) {
  ...
  function t_slds_ActiveSlide(t, e, s) {
    ...
    if (i) {
      ...
      if (o.length) t_onFuncLoad("t_video__getPlayer", (function() {
        o.forEach((function(t) {
          ...
          if ("false" !== t.getAttribute("data-videolazy-load")) {
            ...
            if (s) {
              ...
              i ? i.pause() : t_slds__proccessVideo(s).then((function(t) {
                return t.pause()
              })).catch((function(t) {
                return t
              }))
        ...
        Array.prototype.forEach.call(n, (function(t) {
          t.src && (-1 !== t.src.indexOf("&enablejsapi=1") && t.contentWindow.postMessage(
              '{"event":"command","func":"pauseVideo","args":""}', "*"), -1 === t.src.indexOf("vimeo") || -1 === t
            .src.indexOf("&amp;api=1") && -1 === t.src.indexOf("&api=1") || t.contentWindow.postMessage(
      ...
      if (Array.prototype.forEach.call(a, (function(t) {
        ...
        })), 0 == e && !1 === d) i.querySelector('.t-slds__item[data-slide-index="' + s + '"]').classList.add(
        "t-slds__item_active"), i.setAttribute("aria-hidden", "false");
      ...
      l && (l.classList.add("t-slds__item_active"), l.setAttribute("aria-hidden", "false")), window.t_slds__isiOS &&
        t_slds__hideMobileSlides(l), t_slds__setTabindexForFocusableElements(t)
    }
  }
    ...
    if (e) {
      ...
      if (s) {
        ...
        if ("true" != o.getAttribute("data-slider-stop")) {
          var c = 0;
          o && (c = o.getAttribute("data-slider-items-in-row"), o.style.width = l * d + "px"), window.innerWidth <= 640 ?
            c = 1 : window.innerWidth <= 960 && c > 1 && (c = 2);
          var u = c > 1 ? l / c : l;
          if (u > 0) {
            var _ = e.querySelectorAll(".t-slds__item");
            o && (_ = o.querySelectorAll(".t-slds__item")), Array.prototype.forEach.call(_, (function(t) {
              t.style.width = u + "px"
            }))
          }
        }
  ...
  function t_slds_SliderArrowsHeight(t) {
    ...
    if (e) {
      ...
      r && n.length && Array.prototype.forEach.call(n, (function(t) {
        t.style.height = r + "px";
    ...
    if (a) {
      ...
      if (d) {
        ...
        if (c && clearInterval(c), "true" !== d.getAttribute("data-slider-stop")) {
          var p;
          !/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && l && (l
            .addEventListener("mouseover", (function() {
              d.setAttribute("data-slider-stopped", "yes")
            })), l.addEventListener("mouseout", (function() {
              "y" !== d.getAttribute("data-slider-stopped-by-video") && d.setAttribute("data-slider-stopped", "")
            })));
          ...
          window.addEventListener("resize", t_throttle((function() {
          ...
          }))), void 0 !== document.hidden ? (y = "hidden", v = "visibilitychange") : void 0 !== document.msHidden ? (
            y = "msHidden", v = "msvisibilitychange") : void 0 !== document.webkitHidden && (y = "webkitHidden", v =
            "webkitvisibilitychange"), document.addEventListener(v, (function() {
            if (document[y]) d.setAttribute("data-slider-stopped", "yes");
            else {
              var t = getComputedStyle(a).display,
                e = window.pageYOffset,
                s = e + window.innerHeight;
              f = a.getBoundingClientRect().top + window.pageYOffset, (m = f + a.offsetHeight) > e && f < s &&
                "none" !== t && "y" !== d.getAttribute("data-slider-stopped-by-video") && d.setAttribute(
                  "data-slider-stopped", "")
            }
            ...
            var t = getComputedStyle(a).display,
              e = window.pageYOffset,
              s = e + window.innerHeight;
            "none" !== t ? (f = a.getBoundingClientRect().top + window.pageYOffset, (m = f + a.offsetHeight) >
              e && f < s && "y" !== d.getAttribute("data-slider-stopped-by-video") ? d.setAttribute(
                "data-slider-stopped", "") : "" === d.getAttribute("data-slider-stopped") && d.setAttribute(
                "data-slider-stopped", "yes")) : r || d.setAttribute("data-slider-stopped", "yes")
          })));
          var g = setInterval((function() {
            ...
            "yes" != e && "yes" != r && "yes" != l && ("false" == d.getAttribute("data-slider-with-cycle") && u ==
              s ? u = s : u++, d.setAttribute("data-slider-pos", u), u != s + 1 && 0 != u || (n = "yes"),
              t_slideMoveWithoutAnimation(t, !0, i, o), t_slds_updateSlider(t), "yes" == n && (u == s + 1 && (u =
                1), 0 == u && (u = s), d.setAttribute("data-slider-pos", u)), d.setAttribute("data-slider-cycle",
                n))
          }), o);
        ...
        if (l) {
          ...
          if ("true" !== l.getAttribute("data-slider-stop"))
            if ("true" !== l.getAttribute("data-swiper-initialized")) {
              delete Hammer.defaults.cssProps.userSelect, window.hammer = new Hammer(a, {
                domEvents: !0,
              ...
              var _ = function t(e) {
                  window.pageYOffset > r.getBoundingClientRect().bottom + window.pageYOffset || window.pageYOffset +
                    document.documentElement.clientHeight < r.getBoundingClientRect().top + window.pageYOffset ? l
                    .setAttribute(e, "yes") : "y" !== l.getAttribute("data-slider-stopped-by-video") && l.setAttribute(e,
                      "")
                },
              ...
              if ("IntersectionObserver" in window) new IntersectionObserver((function(t) {
                ...
                o = !0, clearTimeout(d), d = setTimeout((function() {
                  _(p), o = !1
                }), 250)
              }));
              if (1 != e) {
                ...
                window.removeEventListener("touchmove", m, {
                  ...
                  var s = r.querySelector(".t-slds__items-wrapper"),
                    ...
                    l = a > 1,
                    d = l ? r.querySelector(".t-slds__container .t-slds__item").offsetWidth : r.querySelector(
                      ".t-slds__container").offsetWidth,
                  ...
                  if (s.setAttribute("data-slider-touch", "yes"), t_slds_scrollImages(t, d * c - p), e.isFinal) {
                    if (e.velocityX > .4) "false" == s.getAttribute("data-slider-with-cycle") && 1 == c ? c = 1 :
                      c--, s.setAttribute("data-slider-pos", c), 0 == c && (_ = "yes"), s.setAttribute(
                        "data-slider-cycle", _), t_slideMove(t, !1, i);
                    else if (e.velocityX < -.4) {
                      if ("false" == s.getAttribute("data-slider-with-cycle") && (c == u || l && c == u - a + 1))
                        c = l ? u - a : u;
                      else {
                        var v = r.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)"),
                          g = v[v.length - 1],
                          b = parseFloat(g.getAttribute("data-slide-index"), 10);
                        if (b < u && c == b) {
                          var h = document.createEvent("Event");
                          h.initEvent("feedsLastSlide", !0, !0), s.dispatchEvent(h), document.addEventListener(
                            "feedsLoadSlide", (function() {
                              t_slds_updateSlider(t)
                            }))
                        }
                        c++
                      }
                      s.setAttribute("data-slider-pos", c), c == u + 1 && (_ = "yes"), s.setAttribute(
                        "data-slider-cycle", _), t_slideMove(t, !1, i)
                    } else f <= -30 / u ? ("false" == s.getAttribute("data-slider-with-cycle") && (c == u || l &&
                          c == u - a + 1) ? c = l ? u - a : u : c++, s.setAttribute("data-slider-pos", c), c == u +
                        1 && (_ = "yes"), s.setAttribute("data-slider-cycle", _), t_slideMove(t, !1, i)) : f >= m /
                      u ? ("false" == s.getAttribute("data-slider-with-cycle") && 1 == c ? c = 1 : c--, s
                        .setAttribute("data-slider-pos", c), 0 == c && (_ = "yes"), s.setAttribute(
                          "data-slider-cycle", _), t_slideMove(t, !1, i)) : t_slideMove(t, !1, i);
  ...
  function t_slds_changeImageUrl(t) {
    var e = document.getElementById("allrecords"),
      ...
      i = t_slds__getRec(t),
      r;
    i && (r = s ? i.querySelectorAll(".t-slds__img:not([data-original])") : i.querySelectorAll(".t-slds__img"), Array
      .prototype.forEach.call(r, (function(t) {
    ...
    if ("none" !== t.style.display && !t.getAttribute("data-fadeout-timeout")) {
      var i = 1,
        ...
        a, l = setInterval((function() {
          t.style.opacity = i, (i -= .1) <= .1 && (clearInterval(l), t.removeAttribute("data-fadeout-timeout"), t
            .style.display = "none", "function" == typeof s && s())
        }), r > 0 ? r / 10 : 40);
  ...
  function t_slds_fadeIn(t, e, s) {
    if (("1" !== getComputedStyle(t).opacity && "" !== getComputedStyle(t).opacity || "none" === getComputedStyle(t)
        .display) && !t.getAttribute("data-fadein-timeout")) {
      var i = 0,
        r = parseInt(e),
        a = r > 0 ? r / 10 : 40;
      t.style.opacity = i, t.style.display = "block";
      var l = setInterval((function() {
        t.style.opacity = i, (i += .1) >= 1 && (clearInterval(l), t.removeAttribute("data-fadein-timeout"),
          "function" == typeof s && s())
      }), a);
  ...
  function t_slds__proccessVideo(t) {
    return new Promise((function(e, s) {
      t_onFuncLoad("t_video__createPlayer", (function() {
        t_video__createPlayer(t).then((function(t) {
          return e(t)
        })).catch((function(t) {
          return s(t)
        }))
  ...
  function t_triggerEvent(t, e) {
    var s;
    document.createEvent ? (s = document.createEvent("HTMLEvents")).initEvent(e, !0, !1) : document.createEventObject && (
        (s = document.createEventObject()).eventType = e), s.eventName = e, t.dispatchEvent ? t.dispatchEvent(s) : t
      .fireEvent ? t.fireEvent("on" + s.eventType, s) : t[e] ? t[e]() : t["on" + e] && t["on" + e]()
  }
  window.t_slds__isiOS = /iPhone|iPad|iPod/i.test(navigator.userAgent) || navigator.userAgent.indexOf("Macintosh") &&
  ...
  function applyBaseStyles(t) {
    for (var e = t.querySelectorAll(".js-product"), s = 0; s < e.length; s++)
      for (var i, r = e[s].querySelectorAll(".t-store__card__textwrapper"), a = 0; a < r.length; a++) {
        var l = r[a];
        setImportantStyle(l, "margin-bottom", "0px"), setImportantStyle(l, "margin-top", "auto"), setImportantStyle(l,
          "justify-content", "flex-start");
        var d = l.querySelector(".js-store-prod-name");
        d && (setImportantStyle(d, "display", "-webkit-box"), setImportantStyle(d, "-webkit-box-orient", "vertical"),
          setImportantStyle(d, "-webkit-line-clamp", "2"), setImportantStyle(d, "overflow", "hidden"),
          setImportantStyle(d, "text-overflow", "ellipsis"), setImportantStyle(d, "line-height", "1.5"),
          setImportantStyle(d, "max-height", "calc(1.5em * 2)"), setImportantStyle(d, "padding-bottom", "unset"));
        var o = l.querySelector(".js-store-prod-descr");
        o && (setImportantStyle(o, "display", "-webkit-box"), setImportantStyle(o, "-webkit-box-orient", "vertical"),
          setImportantStyle(o, "-webkit-line-clamp", "1"), setImportantStyle(o, "overflow", "hidden"),
          setImportantStyle(o, "text-overflow", "ellipsis"), setImportantStyle(o, "padding-bottom", "unset"))
      }
  ...
  function getReferenceHeight() {
    ...
    for (var e = t.querySelectorAll(".js-product"), s = 0; s < e.length; s++) {
      var i = e[s];
      if ("none" !== window.getComputedStyle(i).display && 0 !== i.offsetHeight && i.querySelector(".js-product-img")) {
      ...
      if (!(t <= 0)) {
        ...
        if (e)
          for (var s = e.querySelectorAll(".js-product"), i = 0; i < s.length; i++) {
            var r = s[i];
            r.querySelector(".js-product-img") ? r.style.height = "" : (r.style.cssText += "; height: " + t +
              "px !important;", DEBUG && console.info("Установлена высота для карточки без изображения:", t))
          }
      }
    }))
  }
  ...
  function attachImageLoadListeners() {
    ...
    if (t)
      for (var e = t.querySelectorAll(".js-product-img"), s = 0; s < e.length; s++) {
        var i = e[s];
        i.complete || i.addEventListener("load", (function() {
      ...
      t.querySelectorAll(".js-product").forEach((function(t) {
        if (!t.querySelector(".js-store-prod-descr.t-store__card__descr")) {
          ...
          if (s && a) {
            ...
            l.className = e.className, l.style.setProperty("height", i + "px", "important"), l.style.setProperty(
                "padding-top", r, "important"), l.style.setProperty("margin-bottom", "0px", "important"), l.style
              .setProperty("display", "-webkit-box", "important"), l.style.setProperty("-webkit-box-orient",
                "vertical", "important"), l.style.setProperty("-webkit-line-clamp", "1", "important"), l.style
              .setProperty("overflow", "hidden", "important"), l.style.setProperty("text-overflow", "ellipsis",
                "important"), s.insertBefore(l, a)
          }
        }
      }))
    }
  ...
  function initGallery() {
    var t = getGalleryContainer();
    if (t) {
      t.removeAttribute("data-styles-applied"), applyBaseStyles(t), t.dataset.stylesApplied = "true",
        addEmptyDescrPlaceholder(t), DEBUG && console.info("Инициализация галереи завершена.");
  ...
  function observePopup() {
    var t = document.querySelector(".t-popup"),
      e;
    t && ("IntersectionObserver" in window ? new IntersectionObserver((function(t, e) {
      for (var s = 0; s < t.length; s++) {
        var i;
        if (t[s].isIntersecting) {
          DEBUG && console.info("Попап видим. Инициализация галереи через 1500 мс"), e.disconnect(), setTimeout(
            initGallery, 1500);
          break
        }
      }
    })).observe(t) : setTimeout(initGallery, 1500))
  }
  ...
  if (window.addEventListener("resize", onResize), window.addEventListener("popstate", onPopstate), window
    .addEventListener("pageshow", onPageshow), window.addEventListener("load", onWindowLoad), document.body &&
