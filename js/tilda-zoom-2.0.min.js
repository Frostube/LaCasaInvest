if (window.t_zoom__isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator
    .userAgent), window.t_zoom__isMobile || (window.t_zoom__isMobile = navigator.userAgent.indexOf("Macintosh") &&
      "ontouchend" in document), window.t_zoom__isiOS = /iPhone|iPad|iPod/i.test(navigator.userAgent), window
    .t_zoom__iOSMajorVersion = 0, window.t_zoom__isiOS) {
    ...
    if (!document.querySelector(".t-zoomer__wrapper")) {
      ...
      var e = document.querySelectorAll("[data-zoomable]"),
        o = Array.prototype.slice.call(e).filter((function(t) {
          return "yes" === t.getAttribute("data-zoomable") && !t.classList.contains("t-slds__thumbs_gallery") &&
      ...
      r.appendChild(n), r.appendChild(a), r.appendChild(i), r.appendChild(l), document.body && document.body
        .insertAdjacentElement("beforeend", r), t_zoom__initFullScreenImgOnClick(), t_zoom__closeAndSlideCarousel()
    }
  }
  ...
  function t_zoom__createCloseBtn() {
    ...
    var e = "";
    return e += '<svg width="20" height="20" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">', e +=
      '<path d="M1.41421 -0.000151038L0 1.41406L21.2132 22.6273L22.6274 21.2131L1.41421 -0.000151038Z" fill="black"/>',
      e += '<path d="M22.6291 1.41421L21.2148 0L0.00164068 21.2132L1.41585 22.6274L22.6291 1.41421Z" fill="black"/>', e +=
      "</svg>", t.insertAdjacentHTML("beforeend", e), t
  }
  ...
  function t_zoom__createScaleBtn() {
    ...
    return e +=
      ...
      e += '<path d="M22.832 22L17.8592 17.0273" stroke="black" stroke-width="2" stroke-linecap="square"/>', e +=
      ...
      e += '<path d="M6.25781 10.3931H16.2035" stroke="black" stroke-width="2"/>', e +=
      '<path d="M11.2305 15.3662V5.42053" stroke="black" stroke-width="2"/>', e += "</svg>", e +=
      '<svg class="icon-decrease" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">',
      e += '<path d="M21.9961 22L17.0233 17.0273" stroke="black" stroke-width="2" stroke-linecap="square"/>', e +=
      ...
      e += '<path d="M5.41797 10.3931H15.3637" stroke="black" stroke-width="2"/>', e += "</svg>", t.insertAdjacentHTML(
        "beforeend", e), t
  }
  ...
  function t_zoom__closeAndSlideCarousel() {
    ...
    t && (t.addEventListener("click", (function() {
      ...
      if (document.body.classList.contains("t-zoomer__show")) switch (t.keyCode) {
        case 27:
  ...
  function t_zoomHandler(t) {
    var e;
    document.body.classList.add("t-zoomer__show"), document.querySelector(".t-popup_show") && document.body.classList.add(
      "t-zoomer__active");
    ...
    n.appendChild(l), n.appendChild(c), n.appendChild(a), r.appendChild(n), o && (o.innerHTML = ""), o && o.appendChild(
    r);
    var s = t.closest(".r"),
      _;
    ...
    return d && (d.style.display = "flex"), t_zoom_setModalColor(s), t_zoom__createAndLoopSlider(t),
      t_zoom__getEventOnBtn(), document.body.classList.add("t-zoomer__show_fixed"), t_zoom__initSingleZoom(),
      t_zoom_checkForScale(), t_zoom_lockScroll(), window.t_zoom__isMobile ? (t_zoom_initSwipe(), t_zoom_initCloseSwipe(),
        window.addEventListener("orientationchange", t_zoom__updateActiveSlidePos)) : window.addEventListener("resize",
        t_zoom__updateActiveSlidePos), window.tzoomopenonce = !0, t_zoom__initEventsonMobile(), !0
  }
  ...
  function t_zoom_createSliderArrow(t) {
    ...
    e.classList.add("t-carousel__zoomer__control"), e.classList.add("t-carousel__zoomer__control_" + t), e.setAttribute(
      "data-zoomer-slide", "left" === t ? "prev" : "next");
    var o = document.createElement("div");
    o.classList.add("t-carousel__zoomer__arrow__wrapper"), o.classList.add("t-carousel__zoomer__arrow__wrapper_" + t);
    var r = document.createElement("div");
    return r.classList.add("t-carousel__zoomer__arrow"), r.classList.add("t-carousel__zoomer__arrow_" + t), r.classList
      .add("t-carousel__zoomer__arrow_small"), o.appendChild(r), e.appendChild(o), e
  }
  ...
  function t_zoom_initSwipe() {
    ...
    if (t.length > 1) {
      var o = new Hammer(e, {
        ...
        r = null,
        n = !1;
      window.tzoomopenonce || (o.on("panstart", (function() {
        var t = document.querySelector(".t-carousel__zoomer__track"),
          o;
        "y" !== t.getAttribute("data-on-transition") ? t && (r = t.getBoundingClientRect().left, t.style
          .transition = "none") : r = null, n = t_zoom__isScaled(e)
        ...
        var o = document.querySelector(".t-carousel__zoomer__track"),
          ...
          l;
        if ("y" !== a && "y" !== i && 1 === t.maxPointers && !n && (Math.abs(t.deltaX) > 40 && o.setAttribute(
            "data-on-drag", "y"), r)) {
          var c = r + t.deltaX;
        ...
        if ("y" !== a && "y" !== i && 1 === o.maxPointers && !n) {
          ...
          var l = Math.abs(o.velocityX),
            ...
            d, m = (s - Math.abs(c + _)) / l / 1e3;
          m > .6 ? m = .6 : m < .2 && (m = .2), r.style.transitionDuration = m + "s", o.velocityX < -.5 || o
            .deltaX < -80 ? (t_zoom_unscale(), t_zoom_showSlide("next"), t_zoom_checkForScale()) : o.velocityX >
            .5 || o.deltaX > 80 ? (t_zoom_unscale(), t_zoom_showSlide("prev"), t_zoom_checkForScale()) :
            t_zoom_showSlide()
        }
      })))
    }
  ...
  function t_zoom__updateSlidesHeight() {
    ...
    if (e && t.length) {
      ...
      o = parseInt(o, 10), isNaN(o) || setTimeout((function() {
        var r = document.querySelector(".t-carousel__zoomer__item.active");
        if (r) {
          var n, a = e.offsetHeight - r.offsetHeight + o,
  ...
  function t_zoom__setEventOnBtn(t) {
    ...
    "y" !== r && "y" !== n && (t_zoom_unscale(), setTimeout((function() {
  ...
  function t_zoom__addingImgsIntoCarousel(t) {
    ...
    if (e ? e.querySelector(".t-slds") : null) {
      ...
      n && (o = n.querySelectorAll(".t-zoomable:not(.t-slds__thumbs_gallery)")), n && n.querySelector(
        ".tn-elem__gallery__video-wrapper") && (o = Array.prototype.slice.call(o)).splice(-1, 1)
    }
    ...
    Array.prototype.forEach.call(o, (function(t, e) {
      var r = t.getAttribute("data-img-zoom-url"),
        ...
        s = r ? r.split(",") : "",
        _, d;
      "IMG" !== t.nodeName && "DIV" !== t.nodeName || (n = t.getAttribute("title") || "", c = t.getAttribute(
        "data-img-zoom-descr") || ""), n && ((_ = document.createElement("div")).classList.add("t-zoomer__title"),
        _.classList.add("t-descr"), _.classList.add("t-descr_xxs"), _.textContent = n, a && a.titleFontFamily && (
          _.style.fontFamily = a.titleFontFamily)), c && ((d = document.createElement("div")).classList.add(
          "t-zoomer__descr"), d.classList.add("t-descr"), d.classList.add("t-descr_xxs"), d.textContent = c, a &&
        a.descrFontFamily && (d.style.fontFamily = a.descrFontFamily));
      var m = document.createElement("div");
      m.classList.add("t-carousel__zoomer__item");
      var u = document.createElement("div");
      u.classList.add("t-carousel__zoomer__wrapper");
      var f = document.createElement("img");
      if (f.classList.add("t-carousel__zoomer__img"), l ? (f.classList.add("t-img"), f.setAttribute("data-original",
          s), 0 !== e && e !== o.length - 1 || f.setAttribute("data-lazy-rule", "skip")) : f.src = s, m.appendChild(
          u), u.appendChild(f), n || c || window.t_zoom__isMobile) {
  ...
  function t_zoom__createAndLoopSlider(t) {
    ...
    if (o && r.length) {
      var n = o.offsetHeight - r[0].offsetHeight,
        a = 0;
      window.t_zoom__isMobile && (a = Array.prototype.reduce.call(r, (function(t, e) {
        var o = e.querySelector(".t-zoomer__comments"),
          r = o ? o.offsetHeight : 0;
        return r > t ? r : t
      }), 0), o.setAttribute("data-max-comment-height", a));
      var i = "y" === window.lazy;
      ...
      var l = t.getAttribute("data-img-zoom-url"),
        c, s = ".t-carousel__zoomer__img[" + (i ? "data-original" : "src") + '="' + l + '"]',
        _ = l ? document.querySelector(s) : null,
        d = _ ? _.closest(".t-carousel__zoomer__item") : null;
      if (d) {
        var m = !!d && d.offsetLeft;
        d.classList.add("active"), t_zoom__hideInnactiveSlides(d, e), e.style.transition = "none", e.style.transform =
          "translateX(" + -m + "px)", setTimeout((function() {
            e.style.transition = ""
          }), 200)
      }
  ...
  function t_zoom__preloadNextSlide(t, e) {
    ...
    if (n) {
      var a = n.querySelector(".t-carousel__zoomer__img"),
        i = "loaded";
      a && !a.classList.contains(i) && t_onFuncLoad("t_lazyload_setSources", (function() {
        t_lazyload_setSources(a, a, "original-set", "original"), a.addEventListener("load", (function() {
          a.classList.add(i)
        }))
      }))
    }
  ...
  function t_zoom_showSlide(t) {
    ...
    if (Array.prototype.forEach.call(o, (function(t, e) {
        t === r && (n = e)
      })), "next" === t || "prev" === t) {
      var i = "next" === t ? n + 1 : o.length + (n - 1);
      n = i % o.length, e.setAttribute("data-on-transition", "y"), window.t_zoom__isMobile && "0s" === getComputedStyle(e)
        .transitionDuration && !a && (e.style.transition = "")
    }
    var l = o[n],
      c = l.offsetLeft;
    if (r.classList.remove("active"), l.classList.add("active"), e.style.transform = "translateX(" + -c + "px)",
      t_zoom__hideInnactiveSlides(l, e), a) {
  ...
  function t_zoom_transitForLoop(t) {
    var e = document.querySelector(".t-carousel__zoomer__track"),
      ...
      r, n;
    t && ("start" === t && (r = o.length - 2), "end" === t && (r = 1), n = o[r].offsetLeft, Array.prototype.forEach.call(
      o, (function(t, e) {
        e === r ? t.classList.add("active") : t.classList.remove("active")
      })), e.style.transition = "none", e.style.transform = "translateX(" + -n + "px)", setTimeout((function() {
  ...
  function t_zoom_loopSlider() {
    ...
    o.classList.remove("active"), r.classList.remove("active"), t_zoom__updateClonedImgSrc(e[0], e[e.length - 1], o, r), t
      .insertBefore(r, t.firstChild), t.appendChild(o);
    ...
    ["transitionend", "webkitTransitionEnd", "oTransitionEnd"].forEach((function(o) {
      t.addEventListener(o, (function() {
        ...
        Array.prototype.forEach.call(e, (function(t, e) {
          ...
          })), 0 === o && t_zoom_transitForLoop("start"), o === n - 1 && t_zoom_transitForLoop("end"), t
          .setAttribute("data-on-transition", "")
      }))
    }))
  }
      ...
      if (!c.some((function(t) {
        ...
        var s = new MutationObserver((function(t) {
          t.forEach((function(t) {
            var e;
            "attributes" === t.type && "src" === t.attributeName && (t.target === n && (e = i), t.target ===
              a && (e = l), t.target === i && (e = n), t.target === l && (e = a), t.target.src && !e.src &&
              (e.src = t.target.src))
          }))
        }));
  ...
  function t_zoom_initCloseSwipe() {
    ...
    n.on("panstart", (function() {
      ...
      if (("y" !== e.getAttribute("data-on-drag") || "y" === t.getAttribute("data-on-drag")) && (n.angle > -120 && n
          .angle < -60 || n.angle < 120 && n.angle > 60) && 1 === n.maxPointers && !o) {
  ...
  function t_zoom_closeSwipeHandler(t) {
    ...
    e.style.transition = "transform 300ms ease-out", Math.abs(t.deltaY) < 40 && (e.style.transform = ""), "y" !== e
      .getAttribute("data-on-drag") || 1 !== t.maxPointers || r || (t.deltaY < -200 || t.velocityY < -.3 ? (e.style
        .transform = "translateY(-100vh)", setTimeout((function() {
          t_zoom_close(), e.style.transform = ""
        }), o)) : t.deltaY > 200 || t.velocityY > .3 ? (e.style.transform = "translateY(100vh)", setTimeout((
    function() {
        t_zoom_close(), e.style.transform = ""
      }), o)) : e.style.transform = ""), e.setAttribute("data-on-drag", "")
  }
  ...
  function t_zoom_checkForScale() {
    ...
    if (t) {
      ...
      } else t.complete ? t_zoom_checkToScaleInit(t) : t.onload = function() {
        t_zoom_checkToScaleInit(t)
      }
    }
  }
  ...
  function t_zoom__waitImgForScale(t, e, o) {
    ...
    else if (Date.now() - e < 3e3) setTimeout((function() {
  ...
  function t_zoom_checkToScaleInit(t) {
    ...
    var n = t.hasAttribute("data-original-svg-height") || t.hasAttribute("data-original-svg-width"),
      ...
      i = parseInt(t.getAttribute("data-original-svg-width"), 10) || t.naturalWidth; - 1 === t.src.indexOf(".svg") ||
      window.isIE || n ? o < a || e < i ? (!window.isDoubletapScaleAdded && window.t_zoom__isMobile &&
        t_zoom_doubletapScaleInit(), t_zoom_scale_init()) : (document.querySelector(".t-zoomer__scale").style.display =
        "", r.classList.add("zoomer-no-scale")) : t_zoom_fetchSVG(t, o, e)
  }
  ...
  function t_zoom_fetchSVG(t, e, o) {
    ...
    fetch(r).then((function(t) {
      ...
      var a = n.querySelector("svg"),
        ...
        c = i / l,
        s = 5e3;
      i > s && (i = s, l = Math.round(i / c)), t.setAttribute("data-original-svg-width", i), t.setAttribute(
          "data-original-svg-height", l), e < l || o < i ? (t.style.width = i + "px", t.style.height = l + "px", !
          window.isDoubletapScaleAdded && window.t_zoom__isMobile && t_zoom_doubletapScaleInit(),
          t_zoom_scale_init()) : document.querySelector(".t-zoomer__scale").style.display = "", document.body
        .removeChild(n)
    }))
  }
  ...
  function t_zoom_scale_init() {
    ...
    e.style.display = "block", "y" !== e.getAttribute("data-zoom-scale-init") && (e.setAttribute("data-zoom-scale-init",
      "y"), t.addEventListener("click", (function(e) {
      ...
      (window.t_zoom__isMobile && e.target.closest(".t-zoomer__scale") && a || !window.t_zoom__isMobile && a && !e
        .target.closest(".t-zoomer__close, .t-carousel__zoomer__control")) && (r.setAttribute(
          "data-on-transition", ""), r.style.transition = "none", r.style.transform = "none", o.style.maxHeight =
        "", t.classList.contains("scale-active") ? t_zoom_unscale() : (t.classList.add("scale-active"), n
          .classList.add("scale-active"), window.t_zoom__isMobile ? t_zoom_mobileZoomPositioningInit(o) :
  ...
  function t_zoom_doubletapScaleInit() {
    ...
    new Hammer(t, {
      ...
      if (2 === e.tapCount && document.body.classList.contains("t-zoomer__show") && !e.target.closest(
        ...
        o.style.maxHeight = "", n.style.transition = "none", n.style.transform = "none", t.classList.contains(
          "scale-active") ? t_zoom_unscale() : (t.classList.add("scale-active"), r.classList.add("scale-active"),
  ...
  function t_zoom_desktopZoomPositioningInit(t, e) {
    var o = (window.innerWidth - t.offsetWidth) / 2,
      ...
      n, a, i, l, c = t.getAttribute("data-original-svg-width") || t.naturalWidth,
      s = t.getAttribute("data-original-svg-height") || t.naturalHeight;
  
    function _(t, e) {
      i = 100 * (void 0 !== t.touches ? t.touches[0].clientX : t.clientX) / window.innerWidth, l = -i * (e.offsetWidth -
        window.innerWidth) / 100, e.style.left = l + "px"
    }
  
    function d(t, e) {
      n = 100 * (void 0 !== t.touches ? t.touches[0].clientY : t.clientY) / window.innerHeight, a = -n * (e.offsetHeight -
        window.innerHeight) / 100, e.style.top = a + "px"
    }
    t.style.left = o + "px", t.style.top = r + "px", window.innerWidth < c && window.innerHeight < s ? (i = 100 * e
      .clientX / window.innerWidth, l = -i * (c - window.innerWidth) / 100, n = 100 * e.clientY / window.innerHeight,
      a = -n * (s - window.innerHeight) / 100, t.style.left = l + "px", t.style.top = a + "px", window
      .t_zoom__isMobile ? t.ontouchmove = function(e) {
        _(e, t), d(e, t)
      } : t.onmousemove = function(e) {
        _(e, t), d(e, t)
      }) : window.innerWidth < c ? (i = 100 * e.clientX / window.innerWidth, l = -i * (c - window.innerWidth) / 100, t
      .style.left = l + "px", window.t_zoom__isMobile ? t.ontouchmove = function(e) {
        _(e, t)
      } : t.onmousemove = function(e) {
        _(e, t)
      }) : window.innerHeight < s && (n = 100 * e.clientY / window.innerHeight, a = -n * (s - window.innerHeight) / 100,
      t.style.top = a + "px", window.t_zoom__isMobile ? t.ontouchmove = function(e) {
        d(e, t)
      } : t.onmousemove = function(e) {
        d(e, t)
      })
  ...
  function t_zoom_mobileZoomPositioningInit(t) {
    ...
    t.ontouchstart = function(t) {
      ...
      var l = t_zoom_getTouchEventXY(i),
        ...
        s = (l.x - n.x) * c,
        _ = (l.y - n.y) * c;
      a.x = r.x + s, a.y = r.y + _, a.x > -e && (a.x = -e), a.x < e && (a.x = e), a.y > -o && (a.y = -o), a.y < o && (a
          .y = o), t.offsetHeight < window.innerHeight && (a.y = 0), t.style.transform = "translate(" + a.x + "px, " + a
        .y + "px)"
  ...
  function t_zoom_close() {
    t_zoom_unscale(), document.body.classList.remove("t-zoomer__show"), document.body.classList.remove(
      "t-zoomer__show_fixed");
    var t = document.querySelector(".t-zoomer__container");
    t && (t.innerHTML = ""), setTimeout((function() {
        document.body.classList.remove("t-zoomer__active")
      }), 200), t_zoom_unlockScroll(), window.t_zoom__isMobile ? (window.removeEventListener("orientationchange",
        t_zoom__updateSlidesHeight), window.removeEventListener("orientationchange", t_zoom__updateActiveSlidePos)) :
  ...
  function t_zoom_unscale() {
    ...
    if (e) {
      ...
      if (r) {
        ...
        var c = i + l;
        n.onmousemove = null, n.ontouchmove = null, n.style.transform = "", n.style.left = "", n.style.top = "", n.style
          .maxHeight = document.documentElement.clientHeight - c + "px"
      }
    }
    ...
    t.length && o.setAttribute("data-cached-zoom", "y"), setTimeout((function() {
      o.style.transition = ""
    }), 100)
  }
  ...
  function t_zoom_lockScroll() {
    var t = /(android)/i.test(navigator.userAgent),
      e;
    if ((window.t_zoom__isiOS && 11 === window.t_zoom__iOSMajorVersion && !window.MSStream || t) && !document.body
      .classList.contains("t-body_scroll-locked")) {
      var o = window.pageYOffset;
      document.body.classList.add("t-body_scroll-locked"), document.body.style.top = "-" + o + "px", document.body
        .setAttribute("data-popup-scrolltop", o.toString())
    }
  }
  ...
  function t_zoom_unlockScroll() {
    ...
    if ((window.t_zoom__isiOS && 11 === window.t_zoom__iOSMajorVersion && !window.MSStream || t) && document.body
      ...
      document.body.classList.remove("t-body_scroll-locked"), document.body.style.top = "", document.body.removeAttribute(
        "data-popup-scrolltop"), window.scrollTo(0, Number(o))
    }
  }
  ...
  function t_zoom_setModalColor(t) {
    var e = "#ffffff",
      ...
      n = r || e,
      a;
    n = -1 !== n.indexOf("-gradient(") ? t_zoom_getFirstColorFromGradient(n) : t_zoom_hexToRgb(n), document
      .getElementById("allrecords") !== document.querySelector(".t-store__product-snippet") && document.getElementById(
        "allrecords").contains(document.querySelector(".t-store__product-snippet")) && t && (n = t.style.backgroundColor);
    var i = document.querySelector(".t-zoomer__container"),
      ...
      _, d, m = document.querySelectorAll(".t-zoomer__title, .t-zoomer__descr"),
      u = "black" === t_zoom_luma_rgb(n) ? o : e;
    u === o ? (_ = e, d = "rgba(1, 1, 1, 0.3)", Array.prototype.forEach.call(s, (function(t) {
      t.classList.add("t-carousel__zoomer__arrow__wrapper_dark")
    }))) : (_ = o, d = "rgba(255, 255, 255, 0.3)", Array.prototype.forEach.call(s, (function(t) {
      t.classList.remove("t-carousel__zoomer__arrow__wrapper_dark")
    }))), Array.prototype.forEach.call(c, (function(t) {
      t.style.background = d
    })), i.style.backgroundColor = u, i.style.color = _, Array.prototype.forEach.call(l, (function(t) {
      "none" === t.getAttribute("fill") ? t.setAttribute("fill", "none") : t.setAttribute("fill", _);
      var e = t.querySelectorAll("path");
      e.length > 0 && Array.prototype.forEach.call(e, (function(t) {
        t.getAttribute("stroke") && t.setAttribute("stroke", _), t.getAttribute("fill") && t.setAttribute(
          "fill", _)
      }))
  ...
  function t_zoom_luma_rgb(t) {
    ...
    return o.length < 3 || .2126 * o[0] + .7152 * o[1] + .0722 * o[2] < 128 ? "black" : "white"
  }
